...
class AddCustomer extends Component{
  ...
  handleSubmit(e){
    ...
    const request = new Request("debit.php")
			...
			<div className = "container-fluid app-wrapper">
				...
				<main className = "container-fluid d-flex p-0 dashboard">
					...
					<div className = "jumbotron add-staff pt-4">
			            <p className = "label text-center" > DEBIT YOUR ACCOUNT </p>
			            <hr className = "my-4"/>
			            ...
			            <form ref = "form1" style = {{"margin":"0 auto"}} className = "text-center company-form">
			            	{
			                  this.state.error
			                  &&
			                  <div className = "p-2 m-2 bg-danger">Account not DEBITED</div>
			                }
			                {
			                  this.state.status
			                  &&
			                  <div className = "p-2 m-2 bg-danger">Debited Successfully</div>
			                }
